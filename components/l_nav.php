...
<nav class="l-nav">
	...
	<div class="l-nav__support">
		<li class="c-subMenu">
			<span class="c-subMenu__mask"></span>
			<a class="c-subMenu__call js-subMenuPrimary">Icons</a>
			<div class="c-subMenu__content">
				<ul class="c-listSupport">
					<li><a href="#"><i>Icon</i><span>(41) 3026-3999</span></a></li>
					<li><a href="#"><i>Icon</i><span>(41) 98806-9129</span></a></li>
	...
	<div class="l-nav__cart">
		<li class="c-subMenu">
			<span class="c-subMenu__mask"></span>
			<a class="c-subMenu__call js-subMenuPrimary">Carrinho</a>
			<div class="c-subMenu__content">
				<div class="c-cart">
					...
					<div class="c-cart__item">
						...
						<div class="item__remove"><i>X</i></div>
					</div>
					<div class="c-cart__item">
						<div class="item__qtf">01</div>
						<div class="item__title">Anel de prata com brilhantes</div>
					...
					<div class="c-cart__total">
						...
						<div class="total__btn"><a href="#" class="c-btn">Fechar Compra</a></div>
					</div>
				</div>
			</div>
		</li>

		...
		<ul class="gridComponent">
			<li class="component">
				...
				<div class="component__content">
					...
					<div class="content__hero">
						<h3>--green</h3>
						<a href="#" class="c-btn --green">c-btn</a>
					</div>
					<div class="content__hero">
						<h3>--secondary</h3>
			...
			<li class="component">
				...
				<div class="component__content">
					...
					<div class="content__hero">
						<h3>--stroke --green</h3>
						<a href="#" class="c-btn --stroke --green">c-btn</a>
					</div>
					<div class="content__hero">
			...
			<li class="component">
				...
				<div class="component__content">
					...
					<div class="content__hero">
						<h3>--small --green</h3>
						<a href="#" class="c-btn --small --green">c-btn</a>
					</div>
					<div class="content__hero">
			...
			<li class="component">
				...
				<div class="component__content">
					...
					<div class="content__hero">
						...
						<a href="#" class="c-btn --small --stroke --green">c-btn</a>
					</div>
					<div class="content__hero">
